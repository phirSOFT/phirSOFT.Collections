...
namespace phirSOFT.LazyDictionary
{
    ...
    public class MnDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IReadOnlyDictionary<TKey, IEnumerable<TValue>>
    {
        ...
        {
            return _store.SelectMany(k => k.Value.Select(v => new KeyValuePair<TKey, TValue>(k.Key, v))).GetEnumerator();
        }
        ...
        public void CopyTo(KeyValuePair<TKey, TValue>[] array, int arrayIndex)
        {
            ...
            {
                while (arrayIndex < array.Length && pairs.MoveNext())
                {
                    array[arrayIndex++] = pairs.Current;
                }
            }
        }
